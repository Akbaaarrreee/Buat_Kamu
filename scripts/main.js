;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKBAR GA BOHONG KOK', 'PENCET LAGI', 'AKBAR TAHU RIRI PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKBAR JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'RIRI PASTI BISA', 'RIRI KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YAA SUDAH DEH', 'I', 'HOPE', 'YOU','HAVE', 'A', 'NICE DAY', 'MAAP KALO BUAT KESEL SEDIKIT']
